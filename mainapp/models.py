...
class News(models.Model):
    ...
    info = models.TextField(
        blank=True,
        verbose_name='News (words)',
        default='')
    raw_info = models.TextField(
        blank=True,
        verbose_name='News (raw)',
        default='')
    raw_converted = models.BooleanField(
        verbose_name='Raw converted', default=False)
...
class TopicNews(models.Model):
    ...
    news_date = models.DateTimeField(
        blank=True, verbose_name='News date', null=True)
    is_send = models.BooleanField(verbose_name='Is send?', default=False)
    send_date = models.DateTimeField(
        blank=True, verbose_name='Send date', null=True)
